...
// Provider is the implementation of `goat.Provider` for accessing Steam
...
// buildUserObject is an internal function to build a goat.User object
// based in the data stored in r
func buildUserObject(r io.Reader, u goat.User) (goat.User, error) {
