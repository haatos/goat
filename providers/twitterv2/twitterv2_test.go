...
func Test_Implements_Provider(t *testing.T) {
	...
	a.Implements((*goat.Provider)(nil), twitterProvider())
}
...
func init() {
	...
	mux.HandleFunc("GET /oauth/request_token", func(w http.ResponseWriter, r *http.Request) {
		fmt.Fprint(w, "oauth_token=TOKEN&oauth_token_secret=SECRET")
	})
	mux.HandleFunc("GET /2/users/me", func(w http.ResponseWriter, r *http.Request) {
