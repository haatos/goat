...
// Provider is the implementation of `goat.Provider` for accessing MAILRU.
...
func (p *Provider) FetchUser(session goat.Session) (_ goat.User, err error) {
	var (
...
func (p *Provider) RefreshToken(refreshToken string) (*oauth2.Token, error) {
	...
	ts := p.oauthConfig.TokenSource(goat.ContextForClient(p.Client()), t)
