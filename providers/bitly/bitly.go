...
// Provider is the implementation of `goat.Provider` for accessing Bitly.
...
// Ensure `bitly.Provider` implements `goat.Provider`.
...
func userFromReader(reader io.Reader, user *goat.User) (err error) {
	u := struct {
